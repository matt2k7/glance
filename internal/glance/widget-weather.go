...
type weatherWidget struct {
	...
	OWMApiKey    string                      `yaml:"owm-api-key"`
...
func (widget *weatherWidget) update(ctx context.Context) {
	...
	if widget.Provider == "openweathermap" {
		w, err := fetchWeatherFromOWM(widget.Place.Latitude, widget.Place.Longitude, widget.Units, widget.OWMApiKey)
